...
module Cassandra
  module Protocol
    describe RawRowsResultResponse do
      ...
      let :raw_rows do
        Protocol.new_buffer("\x00\x00\x00\x02\x00\x00\x00\x04phil\x00\x00\x00\x0dphil@heck.com\xff\xff\xff\xff\x00\x00\x00\x03sue\x00\x00\x00\x0dsue@inter.net\xff\xff\xff\xff")
      end
