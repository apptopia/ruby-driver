            ...
            begin
              ...
              if decision
                ...
                when Retry::Decisions::Ignore
                  trace_id = r.respond_to?(:trace_id) ? r.trace_id : nil
                  promise.fulfill(Results::Void.new(trace_id, keyspace, statement, options, hosts, request.consistency, retries, self, @futures))
